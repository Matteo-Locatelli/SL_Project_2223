...
\begin{center}
\labelText{\texttt{lm\_fit <- lm(pts$\sim$min, data=NbaPlayers)}}{mod:lr1}

\labelText{\texttt{lm\_fit <- lm(pts$\sim$fgm, data=NbaPlayers)}}{mod:lr2}

\labelText{\texttt{lm\_fit\_imp <- lm(pts$\sim$fgm+x3p\_made+ftm, data=NbaPlayers)}}{mod:lr3}

\labelText{\texttt{lm\_fit\_reb <- lm(reb$\sim$oreb+dreb, data=NbaPlayers)}}{mod:lr4}
\end{center}
...
\labelText{\texttt{\texttt{b\_lm\_all <- lm(pts$\sim$.,data=SubNbaPlayers)}}}{mod:lrb1}

\labelText{\texttt{step\_backward\_models[[i]] <- ols\_step\_backward\_p(b\_lm\_all)}}{mod:lrb2}
\end{center}
...
\labelText{\texttt{f\_lm\_all <- lm(pts$\sim$., data=NbaPlayers)}}{mod:lrf1}
...
\labelText{\texttt{ridge\_model <- glmnet(x[train,], y[train], alpha=0, lambda=ridge\_cv\_model\$lambda.min, standardize=TRUE)}}{mod:lrr1}
...
\labelText{\texttt{lasso\_model <- glmnet(x[train,], y[train], alpha=1, lambda=lasso\_cv\_model\$lambda.min, standardize=TRUE)}}{mod:lrl1}
