...
\begin{figure}[H]
	...
	\label{BoostRes}
\end{figure}
\todo{SPIEGARE CHE LA RELATIVE INFLUENCE DEL GRAFICO FA RIFERIMENTO ALLA MIGLIORE DELLE 5000 ITERAZIONI DEL BOOSTIN, OVVERO QUELLA CON ERRORE DI CV MINORE.}
