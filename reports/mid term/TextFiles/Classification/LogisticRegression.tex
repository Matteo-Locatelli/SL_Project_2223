...
\todo{USATO BOOTSTRAP PER CALCOLARE LA VARIANZA DEI REGRESSORI E SCEGLIERE SOLO QUELLI PIù SIGNIFICATIVI (sono gli stessi di quelli del modello A con p-value < 0.01)}
...
\begin{table}[H]
	...
	\label{table:LRBSSum}
\end{table}
\todo{RIFERIMENTI AI MODELLI A E B}
Since the forward model includes all the variables, its analysis is identical to the first one.
\todo{INDICARE IL VALORE DEL P-VALUE PER NON SIGNIFICATIVITà 0.001}
