...
We fit the final model using $\lambda_{opt}$. The resulting coefficients are displayed in \Tab~\ref{table:FinalRidgeCoef} of Appendix~\ref{appendix:lr}. For this model the computed MSE is 1.2577.
